...
MODEL_PATH = "C:\\Users\\david\\Documents\\Proyecto-Gym\\Model\\best2.torchscript"

SOURCE = os.path.join(
    os.path.dirname(os.path.abspath(__file__)),
    "WhatsApp Video 2026-04-21 at 4.21.52 PM.mp4",
)
...
BOX_COLOR = (246, 92, 138)
BOX_COLOR_BG = (180, 60, 100)
